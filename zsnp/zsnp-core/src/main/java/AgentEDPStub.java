 ...
 */
public class AgentEDPStub extends VotingAgent {
...
//    private Integer round = 0;
    ...
    public void init(Game game, Infos own, Map<Integer, Infos> opponents) {
        ...
        index_types = Index_EDP.edp_index(game, own, opponents);
...
//            round = 0;
    ...
    public Map<Integer, Integer> propose() {
        ...
        for (int i = 0; i < index_types.length; i++) {
            ...
            map.put(i, index_types[i]);
            System.out.print("\r\n" + "选择的联盟以及资金分配--成员：" + i + "资金：" + index_types[i]);
        }
