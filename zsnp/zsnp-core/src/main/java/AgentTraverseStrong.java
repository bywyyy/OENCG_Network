 ...
 */
public class AgentTraverseStrong extends VotingAgent {
...
//    private Integer sum_round = 0;
    ...
    public void init(Game game, Infos own, Map<Integer, Infos> opponents) {
        ...
        double player1Ts = (players_map.get(0) / weightSum + 0.4) * 100;
        double player2Ts = (players_map.get(1) / weightSum + 0.4) * 100;
        double player3Ts = (players_map.get(2) / weightSum + 0.4) * 100;

        double player1Tslow = (players_map.get(0) / weightSum) * 100;
        double player2Tslow = (players_map.get(1) / weightSum) * 100;
        double player3Tslow = (players_map.get(2) / weightSum) * 100;
