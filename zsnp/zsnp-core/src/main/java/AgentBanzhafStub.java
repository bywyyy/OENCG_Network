 ...
 */
public class AgentBanzhafStub extends VotingAgent {
    ...
    private float set_sum_weight = 0.0f;

    private float[] index_types;
...
//    private Integer round = 0;
    ...
    public void init(Game game, Infos own, Map<Integer, Infos> opponents) {
        ...
        index_types = Index_Banzhaf.banzhaf_index(game, own, opponents);
